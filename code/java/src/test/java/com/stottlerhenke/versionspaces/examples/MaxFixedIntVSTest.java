 ...
 *
 */
public class MaxFixedIntVSTest {
   ...
   public void testHypotheses_initial() {
      MaxFixedIntVS vs = new MaxFixedIntVS();
      ...
      Assert.assertEquals("Wrong hypothesis.", Integer.MIN_VALUE, h.eval(0).intValue());
   }
   ...
   public void testTrain_simpleExample() {
      VSTest.testVS(new MaxFixedIntVS(), 
            // training examples:
   ...
   public void testTrain_simpleReducingExample() {
      final MaxFixedIntVS vs = new MaxFixedIntVS();
      VSTest.testVS(vs, 
            // training examples:
