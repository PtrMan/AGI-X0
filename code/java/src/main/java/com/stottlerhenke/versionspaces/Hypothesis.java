...
/**
 * A simple interface that represents a hypothesis.
 *  
 * @author rcreswick
 */
public interface Hypothesis<Input, Output> {
   
   /** Evaluate this hypothesis on the provided input */
   public Output eval(Input in);
}
