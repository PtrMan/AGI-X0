package ptrman.agix0.Prototyping;
...
public class CelularAutomata {
    NetworkGlobalState networkGlobalSettings = new NetworkGlobalState();
    ...
    public static void main(String[] arguments) {
        ...
        for( int cellI = 0; cellI < numberOfCells; cellI++ ) {
            rules[cellI] = NetworkGlobalState.celularAutomataRules.sample();
        }
