...
namespace SuboptimalProcedureLearner.SuboptimalProcedureLearner
{
    abstract class Operator
    {
        ...
        public class IntrospectWiringInfo
        {
            public enum EnumType
            {
                FUSINGOPERATOR, // the operator does at some point fuse the input indices together with an operation
                VALIDWIRING,
                NOWIRING // there is no wiring for the chosen input
            }
        ...
        public class ExecutionResult
        {
            ...
            {
                ERROR,
                EXECUTEOPERATORINSTANCE, // the executive has to execute the operator
                RESULT
            }
        ...
        abstract public bool isScaffold();
